jQuery("#simulation")
  .on("click", ".s-45d104d9-bb08-4280-959b-e3e7d8ed1a7b .click", function(event, data) {
          ...
          "blocks": [
            {
              "actions": [
                ...
                },
                {
                  ...
                  "parameter": [ {
                    "target": [ "#s-45d104d9-bb08-4280-959b-e3e7d8ed1a7b #s-Subtraction_4" ],
                    "attributes": {
                      "opacity": "0.7"
                    }
                  },{
  ...
  .on("focusin", ".s-45d104d9-bb08-4280-959b-e3e7d8ed1a7b .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("focusout", ".s-45d104d9-bb08-4280-959b-e3e7d8ed1a7b .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
