jQuery("#simulation")
  .on("click", ".s-1582feba-1257-4ccf-858d-e7bb8ae200f9 .click", function(event, data) {
          ...
          "blocks": [
            {
              "actions": [
                ...
                },
                {
                  ...
                  "parameter": [ {
                    "target": [ "#s-1582feba-1257-4ccf-858d-e7bb8ae200f9 #s-Subtraction_4" ],
                    "attributes": {
                      "opacity": "0.7"
                    }
                  },{
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-1582feba-1257-4ccf-858d-e7bb8ae200f9 #s-Data_grid_2 .s-Button_3" ],
                    "attributes": {
                      "opacity": "0.7"
                    }
                  },{
  ...
  .on("pageload", ".s-1582feba-1257-4ccf-858d-e7bb8ae200f9 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("focusin", ".s-1582feba-1257-4ccf-858d-e7bb8ae200f9 .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("focusout", ".s-1582feba-1257-4ccf-858d-e7bb8ae200f9 .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("variablechange.jim", ".s-1582feba-1257-4ccf-858d-e7bb8ae200f9 .variablechange", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
