jQuery("#simulation")
  .on("click", ".s-fa694501-ba0a-48a3-9e73-9cb32cd01635 .click", function(event, data) {
          ...
          "blocks": [
            {
              "actions": [
                ...
                },
                {
                  ...
                  "parameter": [ {
                    "target": [ "#s-fa694501-ba0a-48a3-9e73-9cb32cd01635 #s-Subtraction_4" ],
                    "attributes": {
                      "opacity": "0.7"
                    }
                  },{
              ...
              "actions": [
                {
                  ...
                  "parameter": {
                    "target": "screens/7b9c6bf2-a5f9-4da5-8313-e5705ad8bcd5"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-fa694501-ba0a-48a3-9e73-9cb32cd01635 #s-Data_grid_1 .s-Button_2" ],
                    "attributes": {
                      "opacity": "0.7"
                    }
                  },{
  ...
  .on("pageload", ".s-fa694501-ba0a-48a3-9e73-9cb32cd01635 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("focusin", ".s-fa694501-ba0a-48a3-9e73-9cb32cd01635 .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("focusout", ".s-fa694501-ba0a-48a3-9e73-9cb32cd01635 .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("variablechange.jim", ".s-fa694501-ba0a-48a3-9e73-9cb32cd01635 .variablechange", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
