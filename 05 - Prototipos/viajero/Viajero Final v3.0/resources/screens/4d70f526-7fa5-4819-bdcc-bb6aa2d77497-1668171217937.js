jQuery("#simulation")
  .on("click", ".s-4d70f526-7fa5-4819-bdcc-bb6aa2d77497 .click", function(event, data) {
  ...
  .on("pageload", ".s-4d70f526-7fa5-4819-bdcc-bb6aa2d77497 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
